...
const correctBlock = `<!-- CONTENT -->
      <div class="wa-content-area" style="padding: 0 16px 24px;">
        ...
        <div id="wa-step-1">
          ...
          <!-- TOP TRUST BADGES -->
          <div style="display:flex; justify-content:space-between; align-items:center; padding:10px 12px; border-bottom:1px solid #e2e8f0; margin-bottom:20px; border:1px solid #f1f5f9; border-radius:12px; box-shadow:0 1px 2px rgba(0,0,0,0.02); gap:4px;">
